...
function rebuildWorld(key) {
  ...
  tile_columns = Math.ceil(width / (tile_width_step_main * 1.75));
  tile_rows = Math.ceil(height / (tile_height_step_main * 1.75));
}
...
function mouseClicked() {
  ...
  let screen_pos = worldToScreen(world_pos, [camera_offset.x, camera_offset.y]);
